...
FalknerGroup:
	...
	db  7,  PIDGEY,     NO_ITEM, GUST, MUD_SLAP, QUICK_ATTACK, NO_MOVE
	db  9,  PIDGEOTTO,  NO_ITEM, TACKLE, STEEL_WING, GUST, WHIRLWIND
	db  13, HOOTHOOT,   BERRY,   PECK, CONFUSION, STEEL_WING, FORESIGHT
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 18, CLEFAIRY,   NO_ITEM,      THUNDERPUNCH, ICE_PUNCH, ENCORE, METRONOME
	db 18, WIGGLYTUFF, NO_ITEM,      POUND, SING, CHARM, DISABLE
...
BugsyGroup:
	...
	db 15, PINECO,     NO_ITEM,  SPIKES, REFLECT, TACKLE, NO_MOVE
	db 14, KAKUNA,     NO_ITEM,  POISON_STING, STRING_SHOT, NO_MOVE, NO_MOVE
	db 15, HERACROSS,  NO_ITEM,  FURY_CUTTER, ROCK_SMASH, ENDURE, REVERSAL
	db 17, SCYTHER,    BERRY,    QUICK_ATTACK, PURSUIT, FURY_CUTTER, FOCUS_ENERGY
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 21, GASTLY,     NO_ITEM,     LICK, SPITE, DESTINY_BOND, CURSE
	...
	db 23, MISDREAVUS, NO_ITEM,     SPITE, MEAN_LOOK, PERISH_SONG, PSYBEAM
	db -1 ; end
...
ClairGroup:
	...
	db 38, GYARADOS,  NO_ITEM,     BITE, THUNDER, SURF, RAIN_DANCE
	db 38, DRAGONAIR, NO_ITEM,     THUNDER_WAVE, THUNDER, FLAMETHROWER, OUTRAGE
	db 37, AMPHAROS,  NO_ITEM,     THUNDERBOLT, FIRE_PUNCH, ICE_BEAM, LIGHT_SCREEN
	db 41, KINGDRA,   MIRACLEBERRY,  SMOKESCREEN, SURF, ICE_BEAM, DRAGONBREATH
	db -1 ; end
